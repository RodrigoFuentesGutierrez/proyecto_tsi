...
$anio = isset($_SESSION['año']) ? $_SESSION['año'] : null;
...
if ($anio1 && $mes1 && $fechai && $fechat) {
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<h1>Informe de asistencia para el rango de fechas $fechai al $fechat del mes $mesNombre del año $anio1</h1>";
...
if ($mes && $anio) {
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        // Verificar si se obtuvieron resultados
        if ($result->num_rows > 0) {
            echo "<h1>Informe de asistencia por sala con mayor asistencia para el mes $mesNombre del año $anio</h1>";
            echo "<table>
                    <tr>
                        <th>Fecha</th>
                        <th>Sala</th>
