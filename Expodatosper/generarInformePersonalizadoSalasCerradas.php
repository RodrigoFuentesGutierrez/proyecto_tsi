...
<body>
    <header>
        ...
        <div class="opciones">
            <a href="../src/menuOpciones.html" title="Ir a Inicio" style="margin-left: 5px; font-size: 25px; position: relative; top:0px;">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <form method="POST" action="visualizar_informe_a_exportars.php">
                            <div class="mes-anio-group d-flex flex-column">
                                <div class="mb-6">
                                <p>En este apartado podra generar el informe por el mes en el que se genero eventualmente</p>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <form method="POST" action="visualizar_informe_a_exportars.php">
                            <div class="mb-12">
                            <p>En este apartado podra generar el informe por dia en el que se genero eventualmente</p>
                                <input type="date" id="fecha" name="fecha" class="form-control">
                                <select name="sala3" id="sala3">
                                    <option value="">Sala</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                    ...
                    <div class="accordion-body">
                        <form method="POST" action="visualizar_informe_a_exportars.php">
                            <div class="mb-12">
                                ...
                                <div class="btn4">
                                    <button type="submit" id="btn4" class="btn btn-primary">Generar reporte</button>
                                </div>
                            </div>
                        </form>
                    </div>
