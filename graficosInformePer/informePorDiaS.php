...
<body>
    ...
    <h1>Informe total de asistencias por fecha para la fecha <?php echo $fecha; ?></h1>
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                <?php
                    ...
                    if ($fecha !== null && $sala3 !== null ) {
                        ...
                        $stmt->bind_param('ss', $fecha, $sala3);
                        $stmt->execute();
                        $result = $stmt->get_result();

                        // Generar los datos para el gráfico
                        while ($row = $result->fetch_assoc()) {
                            echo "['" . $row['intervalo_hora'] . "', " . $row['total'] . "],";
                        }
