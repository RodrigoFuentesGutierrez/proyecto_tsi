...
<body>
    <header>
        ...
        <div class="opciones1">
            <a href="../Expodatosper/generarInformePersonalizadoSalasAbiertas.php" title="Ir a Inicio" style="margin-left: 350px; font-size: 25px; position: relative; top: 4px;">
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                <?php
                    ...
                    if ($anio !== null) {
                        ...
                        $stmt->bind_param('i', $anio); // Aseguramos que el año sea un entero
                        $stmt->execute();
